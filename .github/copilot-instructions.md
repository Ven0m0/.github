...
- **Language standards**: `.github/instructions/<language>.instructions.md`
- **Domain knowledge**: `skills/<domain>/SKILL.md`
- **CI/CD patterns**: `.github/instructions/cicd-standards.instructions.md`
- **Code review rubric**: `.github/instructions/quality-standards.instructions.md`
- **Git workflows**: `skills/gh-cli/SKILL.md`
- **All instructions**: `.github/instructions/INDEX.md`
