...
allowed-tools: "Bash(bun *), Bash(cargo *), Bash(fd *), Bash(git *), Bash(npm *), Bash(pytest *), Bash(rg *), Bash(ruff *), Bash(shellcheck *), Bash(shfmt *), Bash(uv *), Read, Write, Edit, Glob, Grep"
---
