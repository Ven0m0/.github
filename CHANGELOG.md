...
- `.gitattributes` - Git attributes for consistent line endings and linguist config
...
- `.github/workflows/reusable-dependabot-automerge.yml` - Reusable Dependabot auto-merge workflow
