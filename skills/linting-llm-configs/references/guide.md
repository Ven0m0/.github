...
The **linting-llm-configs** skill covers both optimization and validation of AI agent configuration files. Its validation workflow ensures configs are syntactically correct, follow best practices, and remain optimized for LLM triggering and performance. It leverages two core utilities:
